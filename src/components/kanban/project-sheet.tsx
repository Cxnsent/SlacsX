...
export function ProjectSheet({
  ...
  const statusOptions = useMemo(() => {
    ...
    const add = (options: Set<string>, value: string | null | undefined) => {
    ...
    add(options, project.status);
    collectStatusHints(project.metadaten).forEach((status) => add(options, status));
    DEFAULT_STATUSES.forEach((status) => add(options, status));
